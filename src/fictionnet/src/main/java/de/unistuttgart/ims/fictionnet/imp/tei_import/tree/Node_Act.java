 ...
 * @version 11-05-2015
 * 
 *          A poly node that corresponds to an act. Does not have additional functionality.
 */
public class Node_Act extends Node_Poly {
	/**
	 * @param parent
	 ...
	 */
	public Node_Act(Node parent, String requiredTagStart, boolean isLeaf) {
